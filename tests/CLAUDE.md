...
- Next.js tests are separate — they live in `web/src/__tests__/` and use Vitest (225 tests across 18 files, including `reading-time.test.ts` (18), `budget-bar.test.ts` (6), `feed-badges.test.ts` (6), `feed-chip-grid.test.ts` (grouping logic))
